%% Function for Marquart-Levenberg Algorithm

function [r,t,roa4,rms,TimeMarq] = ...
    MultiInv(ab2,roa,r,t,maxiteration,kr,sheet3,realH,realRo)

close all;

x = ab2; iteration = 1; m = [r t]; rinitial = r; tinitial = t;
lr = length(r); lt = length(t); dfit = 1;
...
pause(0.001)
legend('Gözlenen Deðerler','Hesaplanan Deðerler','FontSize',12)
...
legend('Hesaplanan Parametreler','Ön-Kestirim Parametreleri',...
    'Gerçek Parametreler','Location','southwest','FontSize',12)

%Output figure to .jpeg file
set(gcf,'Position', [0 0 1280 720]);
picName = sprintf('%s',sheet3);
print(picName,'-r200','-djpeg');
grid on
